  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-sm text-gray-600 mt-1">Dashboard administrativo completo • Cuide.me</p>
      </div>
      ...
      {dashboard && (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-3">
          ...
          <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg p-3 border border-blue-200">
            ...
            <div className="text-2xl font-bold text-gray-900">{dashboard.demanda.totalFamilias}</div>
            <div className="text-xs text-gray-600">Famílias Ativas</div>
          ...
          <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-lg p-3 border border-purple-200">
            ...
            <div className="text-2xl font-bold text-gray-900">{dashboard.oferta.totalCuidadores}</div>
            <div className="text-xs text-gray-600">Cuidadores Ativos</div>
            <div className="text-xs text-gray-500 mt-1">
          ...
          <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-lg p-3 border border-green-200">
            ...
            <div className="text-2xl font-bold text-gray-900">{dashboard.coreMvp.jobsAtivos}</div>
            <div className="text-xs text-gray-600">Jobs Ativos</div>
            <div className="text-xs text-gray-500 mt-1">
          ...
          <div className="bg-gradient-to-br from-emerald-50 to-emerald-100 rounded-lg p-3 border border-emerald-200">
            ...
            <div className="text-xs text-gray-600">GMV Mensal</div>
            <div className="text-xs text-gray-500 mt-1">
          ...
          <div className="bg-gradient-to-br from-yellow-50 to-yellow-100 rounded-lg p-3 border border-yellow-200">
            ...
            <div className="text-2xl font-bold text-gray-900">{dashboard.confianca.ratingMedio.toFixed(1)}</div>
      ...
      {/* MÓDULOS GRID */}
      <div>
        <h2 className="text-lg font-bold text-gray-900 mb-3">📊 Módulos Disponíveis</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
          {modules.map((module) => (
            <Link
              key={module.id}
              href={module.href}
              className="group relative bg-white rounded-xl shadow-sm border border-gray-200 p-4 hover:shadow-xl hover:scale-105 hover:-translate-y-1 transition-all duration-300"
            >
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-base font-bold text-gray-900 mb-1 group-hover:text-gray-700">
                  {module.title}
                </h3>
                ...
                {/* Bottom Accent */}
                <div className={`mt-3 h-1 bg-gradient-to-r ${module.gradient} rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300`}></div>
              </div>
            </Link>
          ))}
        </div>
