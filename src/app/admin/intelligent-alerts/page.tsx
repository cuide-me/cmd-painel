...
export default function IntelligentAlertsPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Alertas Inteligentes</h1>
          <p className="text-gray-600">Sistema de alertas e notificações da plataforma</p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow p-8 text-center">
          ...
          <p className="text-gray-600 mb-6">
            O sistema de alertas inteligentes está sendo implementado.
          </p>
          <Link
            href="/admin/alerts"
